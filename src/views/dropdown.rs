...
// pub const DROPDOWN_SHOW: Selector = Selector::new("myDROPDOWN_SHOW");
// pub const DROPDOWN_HIDE: Selector = Selector::new("myDROPDOWN_HIDE");
// pub const DROPDOWN_CLOSED: Selector = Selector::new("myDROPDOWN_CLOSED");
